...
class ExtResource(Resource):
	...
	def _urls_handle_m2m_fields(self):
		urls = []
	...
	def _urls_handle_related_fields(self):
		urls= []
	...
	def urls(self, *args, **kwargs):
		...
		urls += self._urls_handle_m2m_fields()
		urls += self._urls_handle_related_fields()
		urls += self._urls_handle_rpc()
		return urls
